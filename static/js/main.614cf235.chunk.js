...
`;var me=()=>{const e=Object(c.p)(),{client:t}=Object(o.useContext)(h);console.log("a new render");const[r,a]=Object(o.useState)((null===t||void 0===t?void 0:t.getPlayerName())||""),[n,i]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerFormula())||""),[s,l]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerResult())||"0"),[d,u]=Object(o.useState)((null===t||void 0===t?void 0:t.getGameNumbersString())||[]),[b,p]=Object(o.useState)(""),[g,x]=Object(o.useState)(""),[j,f]=Object(o.useState)("false"),[y,O]=Object(o.useState)(!1),[v,w]=Object(o.useState)(3),_=e=>{i(e.getCurrentPlayerFormula()),l(e.getCurrentPlayerResult()),u(e.getGameNumbersString()),f(e.getGameStatus()),e.getWinner()&&(p(e.getWinner()),x(e.getWinnerFormula()))};Object(o.useEffect)((()=>{let e;return y&&v>1?e=setTimeout((()=>w((e=>e-1))),1e3):1===v&&(e=setTimeout((()=>{O(!1),w(3)}),1e3)),()=>clearTimeout(e)}),[v,y]);const S=()=>{a(""),i(""),l("0"),u([]),p(""),x("")},k=async e=>{if(t)try{await t.addToken(e),_(t)}catch(r){console.error("Error:",r)}};return Object(m.jsx)(E,{children:Object(m.jsxs)(m.Fragment,{children:[Object(m.jsxs)(I,{children:[Object(m.jsx)(R,{children:"24 Game"}),Object(m.jsxs)(z,{children:["Player: ",r]}),Object(m.jsx)(le,{onClick:async()=>{if(t)try{await t.leaveGame(),S(),t.resetClient(),e("/mode-selection")}catch(r){console.error("Error:",r)}},children:"Quit Game"})]}),b&&Object(m.jsxs)(U,{children:[Object(m.jsx)("h2",{children:"You Solved It!"}),Object(m.jsxs)("div",{children:["Player: ",b]}),Object(m.jsxs)(F,{children:["Winning Formula: ",g]})]}),Object(m.jsx)(D,{children:Object(m.jsxs)(W,{children:[Object(m.jsx)(se,{children:y?Object(m.jsx)("div",{className:"absolute inset-0 flex items-center justify-center",children:Object(m.jsx)("div",{className:"text-4xl font-bold",children:v})}):d.map(((e,t)=>Object(m.jsx)(ae,{onClick:()=>k(e),children:e},t)))}),Object(m.jsx)(T,{children:n||"Start building your formula"}),Object(m.jsxs)($,{children:["Result: ",s]}),Object(m.jsx)(ce,{children:["+","-","*","/","(",")"].map((e=>Object(m.jsx)(ne,{onClick:()=>k(e),children:e},e)))}),Object(m.jsxs)(de,{children:[Object(m.jsx)(ie,{onClick:async()=>{if(t)try{await t.clearFormula(),_(t)}catch(e){console.error("Error:",e)}},children:"Clear"}),Object(m.jsx)(ie,{onClick:async()=>{if(t)try{await t.removeToken(),_(t)}catch(e){console.error("Error:",e)}},children:"Undo"}),Object(m.jsx)(ie,{onClick:async()=>{if(t)try{O(!0),await t.startNewGame(),p(""),x(""),_(t)}catch(e){console.error("Error:",e)}},children:"New Game"})]})]})})]})})};var he=()=>{const e=Object(c.p)(),{client:t}=Object(o.useContext)(h);console.log("a new render");const[r,a]=Object(o.useState)((null===t||void 0===t?void 0:t.getPlayerName())||""),[n,i]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerFormula())||""),[s,l]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerResult())||"0"),[d,u]=Object(o.useState)((null===t||void 0===t?void 0:t.getGameNumbersString())||[]),[b,p]=Object(o.useState)(""),[g,x]=Object(o.useState)(""),[j,f]=Object(o.useState)("false"),y=e=>{i(e.getCurrentPlayerFormula()),l(e.getCurrentPlayerResult()),u(e.getGameNumbersString()),f(e.getGameStatus()),e.getWinner()&&(p(e.getWinner()),x(e.getWinnerFormula()))},O=()=>{a(""),i(""),l("0"),u([]),p(""),x("")},v=async e=>{if(t)try{await t.addToken(e),y(t)}catch(r){console.error("Error:",r)}};return Object(m.jsx)(E,{children:Object(m.jsxs)(m.Fragment,{children:[Object(m.jsxs)(I,{children:[Object(m.jsx)(R,{children:"24 Game"}),Object(m.jsxs)(z,{children:["Player: ",r]}),Object(m.jsx)(le,{onClick:async()=>{if(t)try{await t.leaveGame(),O(),t.resetClient(),e("/mode-selection")}catch(r){console.error("Error:",r)}},children:"Quit Game"})]}),b&&Object(m.jsxs)(U,{children:[Object(m.jsx)("h2",{children:"You Solved It!"}),Object(m.jsxs)("div",{children:["Player: ",b]}),Object(m.jsxs)(F,{children:["Winning Formula: ",g]})]}),Object(m.jsxs)(M,{children:[Object(m.jsxs)(Y,{children:[Object(m.jsx)(se,{children:d.map(((e,t)=>Object(m.jsx)(ae,{onClick:()=>v(e),children:e},t)))}),Object(m.jsx)(T,{children:n||"Start building your formula"}),Object(m.jsxs)($,{children:["Result: ",s]}),Object(m.jsx)(ce,{children:["+","-","*","/","(",")"].map((e=>Object(m.jsx)(ne,{onClick:()=>v(e),children:e},e)))}),Object(m.jsxs)(de,{children:[Object(m.jsx)(ie,{onClick:async()=>{if(t)try{await t.clearFormula(),y(t)}catch(e){console.error("Error:",e)}},children:"Clear"}),Object(m.jsx)(ie,{onClick:async()=>{if(t)try{await t.removeToken(),y(t)}catch(e){console.error("Error:",e)}},children:"Undo"}),Object(m.jsx)(ie,{onClick:async()=>{if(t)try{await t.startNewGame(),p(""),x(""),y(t)}catch(e){console.error("Error:",e)}},children:"New Game"})]})]}),Object(m.jsx)(H,{children:t&&Object.entries(t._cells).filter((e=>{let[t]=e;return t!==r})).map((e=>{let[t,r]=e;return Object(m.jsxs)(J,{children:[Object(m.jsx)(q,{children:t}),Object(m.jsx)(T,{children:r.formula||"No formula yet"}),Object(m.jsxs)($,{children:["Result: ",r.value||"0"]})]},t)}))})]})]})})};var ue=function(){return Object(m.jsx)(s.a,{basename:"/24PointsGameOnline",children:Object(m.jsx)(u,{children:Object(m.jsxs)(c.c,{children:[Object(m.jsx)(c.a,{path:"/",element:Object(m.jsx)(A,{})}),Object(m.jsx)(c.a,{path:"/mode-selection",element:Object(m.jsx)(X,{})}),Object(m.jsx)(c.a,{path:"/rooms",element:Object(m.jsx)(oe,{})}),Object(m.jsx)(c.a,{path:"/game/single",element:Object(m.jsx)(me,{})}),Object(m.jsx)(c.a,{path:"/game/multi/:roomId",element:Object(m.jsx)(he,{})})]})})})};var be=e=>{e&&e instanceof Function&&r.e(3).then(r.bind(null,24)).then((t=>{let{getCLS:r,getFID:o,getFCP:a,getLCP:n,getTTFB:i}=t;r(e),o(e),a(e),n(e),i(e)}))};i.a.createRoot(document.getElementById("root")).render(Object(m.jsx)(a.a.StrictMode,{children:Object(m.jsx)(ue,{})})),be()}},[[23,1,2]]]);
//# sourceMappingURL=main.614cf235.chunk.js.map