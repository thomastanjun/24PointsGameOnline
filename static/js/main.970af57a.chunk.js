...
`;var ne=()=>{const e=Object(c.r)(),[t,r]=Object(o.useState)([]),{client:a}=Object(o.useContext)(h);Object(o.useEffect)((()=>{let e;return a&&(e=setInterval((async()=>{const e=await a.fetchRooms();"Empty"!==e.status?(console.log("RoomList: ",e.status),console.log("RoomListLength: ",e.roomList.length),r(e.roomList)):r([])}),1e3)),()=>clearInterval(e)}),[a]);return Q(a),Object(m.jsxs)(te,{children:[Object(m.jsx)("h1",{children:"Game Rooms"}),Object(m.jsx)(ae,{onClick:()=>(async t=>{if(a)try{const r=await a.createRoom(t);await a.joinGame(r),e(`/game/multi/${r}`,{state:{mode:"multi"}})}catch(r){console.error("Error creating room:",r)}})("8"),children:"Create New Room"}),Object(m.jsx)(re,{children:0===t.length?Object(m.jsx)("p",{children:"No rooms available"}):t.map((t=>Object(m.jsxs)(oe,{children:[Object(m.jsxs)("div",{children:[Object(m.jsxs)("h3",{children:["Room ",t.roomID]}),Object(m.jsxs)("p",{children:["Host: ",t.hostPlayer]}),Object(m.jsxs)("p",{children:["Available Seats: ",t.vacancySeats]})]}),Object(m.jsx)(ae,{onClick:()=>(async t=>{if(a)try{await a.joinGame(t),e(`/game/multi/${t}`)}catch(r){console.error("Error joining room:",r)}})(t.roomID),children:"Join Room"})]},t.roomID)))})]})};const ie=()=>{const e=Object(c.r)(),{client:t}=Object(o.useContext)(h),[r,a]=Object(o.useState)((null===t||void 0===t?void 0:t.getPlayerName())||""),[n,i]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerFormula())||""),[s,l]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerResult())||"0+default"),[d,m]=Object(o.useState)((null===t||void 0===t?void 0:t.getCurrentPlayerError())||"default error"),[u,p]=Object(o.useState)({}),[b,x]=Object(o.useState)((null===t||void 0===t?void 0:t.getGameNumbersString())||[]),[g,j]=Object(o.useState)([]),[f,y]=Object(o.useState)([]),[O,w]=Object(o.useState)(""),[v,k]=Object(o.useState)(""),[_,S]=Object(o.useState)(0),[C,P]=Object(o.useState)(!1),[N,E]=Object(o.useState)(3),G=e=>{i(e.getCurrentPlayerFormula()),m(e.getCurrentPlayerError()),l(e.getCurrentPlayerResult()+e.getCurrentPlayerError()),x(e.getGameNumbersString()),p(e.getOtherPlayers()),w(e.getWinner()),k(e.getWinnerFormula())};return Object(o.useEffect)((()=>{let e;return C&&N>1?e=setTimeout((()=>E((e=>e-1))),1e3):1===N&&(e=setTimeout((()=>{P(!1),E(3)}),1e3)),()=>clearTimeout(e)}),[N,C]),Object(o.useEffect)((()=>{let e;return C||O||(e=setInterval((()=>{S((e=>e+.01))}),10)),()=>clearInterval(e)})),{client:t,playerName:r,formula:n,result:s,error:d,otherPlayers:u,gameNumbers:b,usedButtonIndices:g,winner:O,winnerFormula:v,gameTime:_,isCountingDown:C,count:N,updateDisplay:G,handleTokenClick:async e=>{if(t)try{await t.addToken(e),G(t),y((e=>[...e,-1]))}catch(d){console.error("Error:",d)}},handleNumberTokenClick:async(e,r)=>{if(t)try{await t.addToken(e),G(t),j((e=>[...e,r])),y((e=>[...e,r]))}catch(d){console.error("Error:",d)}},handleRemove:async()=>{if(t)try{await t.removeToken(),G(t),y((e=>{if(0===e.length)return e;const t=e.slice(0,-1),r=e[e.length-1];return r>-1&&j((e=>e.filter((e=>e!==r)))),t}))}catch(d){console.error("Error:",d)}},handleClear:async()=>{if(t)try{await t.clearFormula(),G(t),j([]),y([])}catch(d){console.error("Error:",d)}},handleNewGame:async()=>{if(t)try{await t.startNewGame(),G(t),j([]),y([])}catch(d){console.error("Error:",d)}},handleLogout:async()=>{if(t)try{await t.exitGame(),t.resetClient(),e("/mode-selection")}catch(d){console.error("Error:",d)}}}},se=p.a.button`
  width: 60px;
  height: 60px;
  border: 2px solid #d3d6da;
  border-radius: 4px;
